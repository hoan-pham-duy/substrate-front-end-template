...
const BuyModal = props => {
  ...
  return <Modal onClose={() => setOpen(false)} onOpen={() => setOpen(true)} open={open}
    ...
    <Modal.Content><Form>
      <Form.Input fluid label='Kitty ID' readOnly value={kitty.id}/>
      <Form.Input fluid label='Bid Price' placeholder='Bid Price' onChange={formChange('target')}/>
    </Form></Modal.Content>
    <Modal.Actions>
      <Button basic color='grey' onClick={() => setOpen(false)}>Cancel</Button>
      <TxButton
...
const Breed = props => {
  ...
  return <Modal onClose={() => setOpen(false)} onOpen={() => setOpen(true)} open={open}
    ...
    <Modal.Content><Form>
      <Form.Input fluid label='Kitty ID' readOnly value={kitty.id}/>
      <Form.Input fluid label='Kitty breed partner' placeholder='Enter Kitty breed partner' onChange={formChange('target')}/>
    </Form></Modal.Content>
    <Modal.Actions>
      <Button basic color='grey' onClick={ () => setOpen(false)}>Cancel</Button>
      <TxButton
  ...
  return <Card>
    ...
    <Card.Content extra style={{ textAlign: 'center' }}>{ owner === accountPair.address
      ? <>
          ...
          <Breed kitty={kitty} accountPair={accountPair} setStatus={setStatus}/>
        </>
